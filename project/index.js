...
define(Component.input, (t) => {
            ...
            const btnViewReady = button({onclick: () => getStore().td.actions.setView("ready"), class: getBtnClassByView(view, "ready")}, "Ready")
            ...
            const btnViewAll = button({onclick: () => getStore().td.actions.setView("all"), class: getBtnClassByView(view, "all")}, "All")
